...
local bg_color=$BG[216]
  ...
  PROMPT='%{$reset_color%}$bg_color%{$fg[$user_color]%}%n@:$bg_color$pwd_color$(_fishy_collapsed_wd)%{$reset_color%}%(!.#.) $(_omz_git_prompt_info|tr -d " ")%b$(kube_ps1)${NEWLINE}➤ %{$reset_color%}'
