...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-rg", "cmp-buffer", "cmp-cmdline", "cmp-npm", "cmp-vsnip", "cmp-path" },
...
vim.cmd [[au BufReadPost * ++once lua require("packer.load")({'nvim-ts-rainbow', 'nvim-treesitter-textsubjects', 'nvim-treesitter-textobjects', 'targets.vim', 'fzf'}, { event = "BufReadPost *" }, _G.packer_plugins)]]
