...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-path", "cmp-vsnip", "cmp-cmdline", "cmp-buffer", "cmp-rg", "cmp-npm" },
...
vim.cmd [[au BufReadPost * ++once lua require("packer.load")({'nvim-treesitter-textsubjects', 'fzf', 'nvim-treesitter-textobjects', 'nvim-ts-rainbow', 'targets.vim'}, { event = "BufReadPost *" }, _G.packer_plugins)]]
