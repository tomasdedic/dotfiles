...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-cmdline", "cmp-npm", "cmp-path", "cmp-buffer", "cmp-vsnip", "cmp-rg" },
  ...
  ["vim-go"] = {
    loaded = true,
    path = "/home/ts/.local/share/nvim/site/pack/packer/start/vim-go",
  ...
  ["vim-helm"] = {
    loaded = true,
    path = "/home/ts/.local/share/nvim/site/pack/packer/start/vim-helm",
    url = "https://github.com/towolf/vim-helm"
  },
  ["vim-markdown"] = {
    loaded = true,
    path = "/home/ts/.local/share/nvim/site/pack/packer/start/vim-markdown",
...
vim.cmd [[au BufReadPost * ++once lua require("packer.load")({'fzf', 'nvim-treesitter-textobjects', 'targets.vim', 'nvim-ts-rainbow', 'nvim-treesitter-textsubjects'}, { event = "BufReadPost *" }, _G.packer_plugins)]]
