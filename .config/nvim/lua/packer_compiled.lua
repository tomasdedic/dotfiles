...
_G.packer_plugins = {
  ["Comment.nvim"] = {
    config = { "\27LJ\2\n3\0\0\3\0\2\0\0046\0\0\0'\2\1\0B\0\2\1K\0\1\0\24pluginsconf.comment\frequire\0" },
    loaded = true,
    path = "/home/ts/.local/share/nvim/site/pack/packer/start/Comment.nvim",
  ...
  ["impatient.nvim"] = {
    loaded = true,
    path = "/home/ts/.local/share/nvim/site/pack/packer/start/impatient.nvim",
  ...
  ["nvim-cmp"] = {
    after = { "cmp-npm", "cmp-vsnip", "cmp-rg", "cmp-cmdline", "cmp-buffer", "cmp-path" },
  ...
  ["nvim-neoclip.lua"] = {
    config = { "\27LJ\2\n“\1\0\0\3\0\a\0\v6\0\0\0'\2\1\0B\0\2\0029\0\2\0005\2\3\0B\0\2\0016\0\4\0009\0\5\0'\2\6\0B\0\2\1K\0\1\0Vnnoremap <leader>y <cmd>lua require('telescope').extensions.neoclip.default()<CR>\bcmd\bvim\1\0\2\20continuous_sync\2\30enable_persistent_history\2\nsetup\fneoclip\frequire\0" },
    loaded = true,
  ...
  ["vim-gitgutter"] = {
    loaded = true,
    path = "/home/ts/.local/share/nvim/site/pack/packer/start/vim-gitgutter",
  ...
  ["vim-grepper"] = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "/home/ts/.local/share/nvim/site/pack/packer/opt/vim-grepper",
...
try_loadstring("\27LJ\2\n3\0\0\3\0\2\0\0046\0\0\0'\2\1\0B\0\2\1K\0\1\0\24pluginsconf.comment\frequire\0", "config", "Comment.nvim")
...
vim.cmd [[au BufReadPost * ++once lua require("packer.load")({'nvim-ts-rainbow', 'nvim-treesitter-textsubjects', 'fzf', 'nvim-treesitter-textobjects', 'targets.vim'}, { event = "BufReadPost *" }, _G.packer_plugins)]]
