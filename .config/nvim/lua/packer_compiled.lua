...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-cmdline", "cmp-buffer", "cmp-vsnip", "cmp-rg", "cmp-npm", "cmp-path" },
...
vim.cmd [[au BufReadPost * ++once lua require("packer.load")({'targets.vim', 'nvim-treesitter-textsubjects', 'nvim-treesitter-textobjects', 'nvim-ts-rainbow', 'fzf'}, { event = "BufReadPost *" }, _G.packer_plugins)]]
