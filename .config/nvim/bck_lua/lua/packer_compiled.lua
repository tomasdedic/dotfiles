...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-npm", "cmp-rg", "cmp-buffer", "cmp-vsnip", "cmp-path", "cmp-cmdline" },
...
pcall(vim.api.nvim_create_user_command, 'Gvdiffsplit', function(cmdargs)
        ...
        {nargs = '*', range = true, bang = true, complete = function()
          require('packer.load')({'vim-fugitive'}, { cmd = 'Gvdiffsplit' }, _G.packer_plugins)
...
vim.cmd [[au BufReadPost * ++once lua require("packer.load")({'fzf', 'targets.vim', 'nvim-ts-rainbow', 'nvim-treesitter-textobjects', 'nvim-treesitter-textsubjects'}, { event = "BufReadPost *" }, _G.packer_plugins)]]
