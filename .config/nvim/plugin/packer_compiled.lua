...
vim.cmd [[au BufReadPost * ++once lua require("packer.load")({'targets.vim', 'nvim-treesitter-textsubjects', 'nvim-treesitter-textobjects', 'fzf', 'nvim-ts-rainbow'}, { event = "BufReadPost *" }, _G.packer_plugins)]]
