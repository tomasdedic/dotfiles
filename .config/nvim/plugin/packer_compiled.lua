...
_G.packer_plugins = {
  ...
  ["gopher.nvim"] = {
    config = { "\27LJ\2\nû\1\0\0\4\0\6\0\t6\0\0\0'\2\1\0B\0\2\0029\0\2\0005\2\4\0005\3\3\0=\3\5\2B\0\2\1K\0\1\0\rcommands\1\0\0\1\0\5\niferr\niferr\17gomodifytags\17gomodifytags\ago\ago\fgotests\21~/go/bin/gotests\timpl\timpl\nsetup\vgopher\frequire\0" },
    loaded = false,
    needs_bufread = false,
    only_cond = false,
  ...
  ["nvim-cmp"] = {
    after = { "cmp-npm", "cmp-buffer", "cmp-cmdline", "cmp-path", "cmp-vsnip", "cmp-rg" },
...
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'indent-blankline.nvim', 'nvim-autopairs'}, { event = "InsertEnter *" }, _G.packer_plugins)]]
vim.cmd [[au BufRead * ++once lua require("packer.load")({'gitsigns.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
vim.cmd [[au BufReadPost * ++once lua require("packer.load")({'fzf', 'targets.vim', 'nvim-ts-rainbow', 'nvim-treesitter-textsubjects', 'nvim-treesitter-textobjects'}, { event = "BufReadPost *" }, _G.packer_plugins)]]
