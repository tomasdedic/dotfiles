...
_G.packer_plugins = {
  ...
  ["gopher.nvim"] = {
    config = { "\27LJ\2\nû\1\0\0\4\0\6\0\t6\0\0\0'\2\1\0B\0\2\0029\0\2\0005\2\4\0005\3\3\0=\3\5\2B\0\2\1K\0\1\0\rcommands\1\0\0\1\0\5\17gomodifytags\17gomodifytags\fgotests\21~/go/bin/gotests\timpl\timpl\niferr\niferr\ago\ago\nsetup\vgopher\frequire\0" },
    loaded = false,
    needs_bufread = false,
    only_cond = false,
...
vim.cmd [[au BufReadPost * ++once lua require("packer.load")({'fzf', 'nvim-ts-rainbow', 'nvim-treesitter-textsubjects', 'nvim-treesitter-textobjects', 'targets.vim'}, { event = "BufReadPost *" }, _G.packer_plugins)]]
