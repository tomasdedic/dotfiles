...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-vsnip", "cmp-cmdline", "cmp-buffer", "cmp-rg", "cmp-path", "cmp-npm" },
...
vim.cmd [[au BufReadPost * ++once lua require("packer.load")({'nvim-treesitter-textsubjects', 'nvim-treesitter-textobjects', 'fzf', 'targets.vim', 'nvim-ts-rainbow'}, { event = "BufReadPost *" }, _G.packer_plugins)]]
