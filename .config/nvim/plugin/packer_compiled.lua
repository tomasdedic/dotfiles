...
_G.packer_plugins = {
  ...
  ["codeium.nvim"] = {
    ...
    loaded = true,
    path = "/home/ts/.local/share/nvim/site/pack/packer/start/codeium.nvim",
  ...
  ["nvim-cmp"] = {
    after = { "cmp-buffer", "cmp-rg", "cmp-path", "cmp-vsnip", "cmp-cmdline", "cmp-npm" },
...
vim.cmd [[au BufReadPost * ++once lua require("packer.load")({'nvim-treesitter-textsubjects', 'nvim-treesitter-textobjects', 'nvim-ts-rainbow', 'targets.vim', 'fzf'}, { event = "BufReadPost *" }, _G.packer_plugins)]]
