...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-npm", "cmp-buffer", "cmp-vsnip", "cmp-path", "cmp-cmdline", "cmp-rg" },
...
vim.cmd [[au BufReadPost * ++once lua require("packer.load")({'nvim-ts-rainbow', 'nvim-treesitter-textsubjects', 'fzf', 'targets.vim', 'nvim-treesitter-textobjects'}, { event = "BufReadPost *" }, _G.packer_plugins)]]
